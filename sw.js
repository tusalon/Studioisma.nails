...
const urlsToCache = [
  ...
  '/Studioisma.nails/utils/push-config.js',
  '/Studioisma.nails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/Studioisma.nails/icons/icon-192x192.png',
    badge: '/Studioisma.nails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/Studioisma.nails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/Studioisma.nails/admin.html';
  event.waitUntil(
